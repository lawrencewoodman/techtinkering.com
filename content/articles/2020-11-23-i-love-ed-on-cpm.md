...
<div class="overflow-auto"><table class="neatTable neatBorder">
  ...
  <tr><td>0W</td><td>Write half of the buffer to the new file.  Useful to make room if the buffer is full.</td></tr>
  ...
  <tr><td>0LT</td><td>Move CP to beginning of line and display line</td></tr>
