...
To see if when you were born does affect your future, I have decided to look at various groups over a series of articles.  For this, the first article, I am beginning with Nobel laureates, as they come from many different countries, represent excellence in their field and they are reasonably well documented on [wikipedia](https://wikipedia.org).  The data for the study was collected by using [ScraperWiki](https://scraperwiki.com) to build a series of scrapers and views to go through the [List of Nobel laureates](https://en.wikipedia.org/wiki/List_of_nobel_prize_winners) and find the _Date of Birth_ for each person.
